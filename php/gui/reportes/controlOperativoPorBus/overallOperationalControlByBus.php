...
if (!$mysqli = getConectionDb()) {
    ...
    //para calcular los numeros de dias entre dos fecha
    $dias = (strtotime('2014-08-28') - strtotime('2014-09-04'));
    $dias = abs($dias) / 86400;
    $dias = floor($dias);

    //para sumarle dias a una fecha

    list($year, $mon, $day) = explode('-', '2014-08-30');
    $fechaFin = date('Y-m-d', mktime(0, 0, $year, $mon, $day + $dias));
