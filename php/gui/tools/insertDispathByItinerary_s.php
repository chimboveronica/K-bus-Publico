...
if (!$mysqli = getConectionDb()) {
    ...
    $success = false;
    $consultaSql = "select id_ruta, tiempo from itinerarios_s where num_vehiculos = $numberVehicles and id_turno = $id_turno";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "{failure:true, message:'El Itinerario no se encuentra en el Sistema.'}";
    }
    $mysqli->close();
}