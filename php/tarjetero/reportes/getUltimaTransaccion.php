...
/* $bus = 1 :> El parametro enviado es una cedula
 * $bus = 2 :> El parametro enviado es una tarjeta
 * $bus = 3 :> El parametro enviado es un punto de venta/recarga
*/
...
$consultaSql3 = "SELECT * FROM transline WHERE CardNo = '".$cn."' ORDER BY TransDate DESC LIMIT 1";
